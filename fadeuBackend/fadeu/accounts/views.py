...
from users.serializers import CustomTokenObtainPairSerializer # Import CustomTokenObtainPairSerializer
...
class EmailTokenObtainPairView(TokenObtainPairView):
    serializer_class = CustomTokenObtainPairSerializer # Use CustomTokenObtainPairSerializer
