      ...
      itemBuilder: (context, index) {
        ...
        return Dismissible(
          ...
          onDismissed: (direction) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text(AppLocalizations.of(context)!.wordRemoved(word.germanWord ?? 'Word'))),
            );
          },
          child: Card(
            ...
            child: ListTile(
              title: BiDirectionalText(
                ...
                style: TextStyle(
                    ...
                    fontSize: 16),
                forceLTR: true, // German words should always be LTR
              ),
              subtitle: BiDirectionalText(
                word.persianWord ?? AppLocalizations.of(context)!.noTranslationAvailable,
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          AppLocalizations.of(context)!.noSavedWords,
      ...
      child: Stack( 
        children: [
          _isLoading
              ...
              : _savedWords.isEmpty
                  ? Center(
                      child: Text('${AppLocalizations.of(context)!.noSavedWords}\n${AppLocalizations.of(context)!.pullToRefresh}',
                          textAlign: TextAlign.center,
                ...
                onPressed: () {
                  showDialog(
                    ...
                    builder: (BuildContext dialogContext) {
                      return AlertDialog(
                        title: Text(AppLocalizations.of(context)!.clearAllConfirmation),
                        content: Text(AppLocalizations.of(context)!.clearAllDescription),
                        actions: <Widget>[
                          TextButton(
                          ...
                          TextButton(
                            ...
                            onPressed: () {
                              ...
                              if(mounted) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(content: Text(AppLocalizations.of(context)!.allWordsCleared)),
                                );
                              }
                            },
                          ),
