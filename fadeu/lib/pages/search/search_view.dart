...
class _SearchViewState extends State<SearchView> {
  ...
  final String _backendUrl = 'http://127.0.0.1:8000'; // Update with your backend URL
          ...
          child: Builder(builder: (context) {
            ...
            if (showResults) {
              if (_displayResults.isEmpty) {
                return Center(child: Text('No results found.', style: TextStyle(color: themeColor.withOpacity(0.7))));
              }
            ...
            return Center(child: Text('Start typing to search!', style: TextStyle(color: themeColor.withOpacity(0.7))));
          }),
        ),
      ],
    );
      ...
      itemBuilder: (context, index) {
        ...
        if (item is String) { 
          ...
          return Padding(
            ...
            child: Text(item, style: const TextStyle(color: Colors.deepPurple, fontSize: 16, fontWeight: FontWeight.bold)),
          );
        }
        ...
        if (item is Word) { 
          ...
          return ListTile(
            title: Text(item.germanWord ?? 'N/A', style: TextStyle(color: themeColor, fontWeight: FontWeight.bold)),
            subtitle: Text(item.persianWord ?? 'No translation', style: const TextStyle(color: Colors.blueAccent, fontSize: 16)),
            trailing: IconButton(
              icon: Icon(
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text("Recent Searches", style: TextStyle(color: themeColor.withOpacity(0.8), fontSize: 16, fontWeight: FontWeight.bold)),
              TextButton(onPressed: _clearAllSearchHistory, child: const Text("Clear All")),
            ],
          ),
        ),
        Expanded(
