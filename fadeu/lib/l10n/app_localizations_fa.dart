...
class AppLocalizationsFa extends AppLocalizations {
  ...
  String get totalStudyTimeDescription =>
      'مجموع زمان صرف شده برای تماشای ویدیوها و یادگیری.';
  ...
  String get wordsSearchedDescription =>
      'تعداد کلمات منحصر به فردی که جستجو کرده‌اید.';
  ...
  String get wordsSavedDescription =>
      'تعداد کلماتی که برای مرور بعدی ذخیره کرده‌اید.';
  ...
  String get flashcardsViewedTotalDescription =>
      'مجموع تعداد فلش‌کارت‌هایی که مرور کرده‌اید.';
  ...
  String get longestDailyStreakDescription =>
      'رکورد شما برای روزهای متوالی استفاده از برنامه.';
  ...
  String get errorInitializingData =>
      'خطا در بارگذاری اولیه داده‌های فعالیت کاربر. لطفاً برنامه را مجدداً راه‌اندازی کنید.';
  ...
  String get wordRemindersDescription =>
      'کانالی برای اعلان‌های دوره‌ای یادگیری کلمات.';
  ...
  String get couldNotConnectToServerCheckInternet =>
      'خطا: امکان اتصال به سرور وجود ندارد. لطفاً اتصال اینترنت خود را بررسی کنید.';
  ...
  String get resetPasswordInstruction =>
      'برای دریافت لینک بازنشانی، ایمیل خود را وارد کنید';
  ...
  String get resetEmailSentConfirmation =>
      'ایمیل بازنشانی ارسال شد. لطفاً صندوق ورودی خود را بررسی کنید.';
  ...
  String get setNewPasswordInstruction =>
      'یک رمز عبور جدید برای حساب خود ایجاد کنید';
